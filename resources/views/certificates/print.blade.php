...
<head>
    ...
    {{-- HU-12.9: Versión imprimible. El navegador la exporta a PDF con Ctrl+P → "Guardar como PDF" --}}
    <title>{{ $certificate->certificate_code }} - Constancia de Estudios</title>
    <style>
...
<body>
    <div class="print-toolbar">
        ...
        <a href="{{ route('certificates.index') }}">Volver al listado</a>
    </div>
