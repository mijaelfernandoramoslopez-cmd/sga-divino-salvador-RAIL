<x-layouts.app-layout title="Anular Constancia">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                <div class="card-header card-header-text">
                    <h4 class="card-title">¿Está seguro de anular la constancia?</h4>
                    <p class="text-muted">
                ...
                <div class="card-content table-responsive">
                    <form action="{{ route('certificates.destroy', $certificate->idcertificate) }}" method="POST">
                        @csrf
                        @method('DELETE')
