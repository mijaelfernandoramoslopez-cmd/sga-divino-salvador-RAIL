        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                ...
                <div class="card-content">
                    ...
                    <form action="{{ route('teachers.update-password', $teacher->idteacher) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="{{ $teacher->dni }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Nombre del docente</label>
                                    <input type="text" readonly class="form-control" value="{{ $teacher->full_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted"><span class="text-danger">Mínimo 6 caracteres.</span></small>
