        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                <div class="card-header card-header-text">
                    <h4 class="card-title">Actualizar contraseña del estudiante</h4>
                </div>
                ...
                <div class="card-content">
                    ...
                    <form action="{{ route('students.update-password', $student->idstudent) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="{{ $student->dni }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
